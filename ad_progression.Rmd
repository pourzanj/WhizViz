...
The model fit reveals the relative order of biomarker onset.
...
I-Splines are a flexible and adjustable set of basis functions used to model monotonic functions [@ramsay1988monotone].
